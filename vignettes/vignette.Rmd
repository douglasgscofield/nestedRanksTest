...
an aggregate between-year difference in acorn movement distances that we are
curious about.  In model terms, a better test would treat year as a fixed
effect and granary as a random effect, akin to a [mixed model][MixedModel].
This was our motivation for developing `nestedRanksTest`.
