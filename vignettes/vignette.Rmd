...
This also feels not quite on the mark, in addition to having problems meeting
`wilcox.test` assumptions for granary 151 with coast live oak.  We could find
or develop a technique to combine the p-values while taking into account the
individual successes and failures, but this solution still does not fit the
scale of our original question: Are there *overall* differences in seed
movement between high- and low-crop years?
