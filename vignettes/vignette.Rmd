...
(*Quercus lobata*)][ValleyOak], while acorns were harvested from both valley oak
and [coast live oak (*Quercus agrifolia*)][LiveOak].
...
# Nested ranks test: What you should know

Syntax differences and different interface expectations.
Conversions to factors for both treatment and group.
Weights, why?  
...
Distance ~ Year | Granary
Distance ~ Year, groups = Granary
Year, Distance, Granary
x = Year, y = Distance, groups = Granary
