...
landscape via dispersal of pollen and seeds, as well as developing analytic
methods to help study dispersal.  I did post-doctoral research in Dr Sork's lab
exploring these topics.

[Acorn woodpeckers (*Melanerpes formicivorus*)][KoenigMumme] are highly social,
with each social group maintains its own granary or granaries in which it
stores up to thousands of acorns which are primarily used to augment food
resources during breeding.  [Granaries][GranaryImageSearch] are constructed by
...
year-to-year comparisons was: Do woodpeckers forage for acorns farther from their
granaries during years of low acorn production?  This is a common-sense
...
Acorn woodpecker territories contain a number of mature oak trees at varying
distances from the granary.  Because each granary has its own neighbourhood of
oak trees, it would not be a very precise test to look for overall differences
in acorn movement within the entire savannah, on the other hand looking for
differences within each granary individually would have required greater than
practical sample sizes to have sufficient statistical power.
