...
Mann-Whitney-Wilcoxon test statistic is then computed.  The scale of this
...
*n*<sub>2</sub> are group-specific sample sizes for treatment levels 1 and 2,
respectively. The statistic is scaled to [-1, +1] by dividing by
